...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/Mahendra Gawande/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Mahendra Gawande_",
    icon: Instagram,
    url: "https://www.instagram.com/Mahendra Gawande_/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Mahendra Gawande",
    icon: Github,
    url: "https://github.com/Mahendra Gawande",
    color: "#ffffff",
